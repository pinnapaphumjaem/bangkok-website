const langData = {
 ...
 jp:{
  ...
  watphra_title:"ワット・プラケオ",
  watphra_desc:"ワット・プラケオはタイで最も神聖な寺院であり、国家の精神的および文化的アイデンティティの礎となっています。王宮（グランドパレス）の敷地内に位置し、この寺院には繁栄、守護、そして王権の正当性を象徴するエメラルド仏が安置されています。この仏像は一つの翡翠の塊から彫られており、タイの人々から非常に深い尊敬を集めています。また、季節ごとに衣装を替える儀式は国王によって執り行われる重要な王室儀礼です。
